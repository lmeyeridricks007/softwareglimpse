...
const nextConfig: NextConfig = {
  ...
  /**
   * Legacy + software-tab permanent redirects.
   * Reverse comparison aliases (thousands) live in `src/proxy.ts` — next.config
   * + Vercel reject a routes manifest of that size at deploy time.
   * Source of truth for EN legacy: config/legacy-redirects.json.
   */
  async redirects() {
    return [...toNextConfigRedirects(), ...softwareTabRedirects()];
  },
  /**
