...
export const salesIntelligenceVsLinkedinSalesNavigatorGuide: GuidePageInput = {
  ...
  blocks: salesIntelligenceVsLinkedinSalesNavigatorBlocks as GuidePageInput["blocks"],
  checklist: [
    {
      id: "job",
