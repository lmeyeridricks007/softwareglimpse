...
const softwareSeedRaw: SoftwareInput[] = [
  ...
  soft({
    ...
    subcategorySlugs: [],
    useCaseSlugs: ["online-courses","course-commerce","creator-marketing","funnel-building","lead-generation","multichannel-campaigns","employee-training","sop-documentation"],
    teamTypeSlugs: ["marketing","founders"],
    businessSizeSlugs: ["micro","small-business","mid-market"],
  ...
  soft({
    ...
    primaryCategorySlug: "marketing",
    subcategorySlugs: [],
    useCaseSlugs: ["lead-generation","analytics","marketing-attribution"],
    teamTypeSlugs: ["marketing"],
    businessSizeSlugs: ["micro","small-business","mid-market"],
