...
export function CategoryUseCases({
  title,
  items,
  emptyHint = "Use-case pages for this category are still being added. Start with Finder or Explore paths above.",
  className,
}: Props) {
  return (
    <section
