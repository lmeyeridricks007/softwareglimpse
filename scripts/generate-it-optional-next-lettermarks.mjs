...
const MARKS = [
  { slug: "topdesk", letter: "T", bg: "#0B3D3A", accent: "#2BBBAD" },
  { slug: "ivanti", letter: "I", bg: "#1A1510", accent: "#F97316" },
  { slug: "bmc-helix", letter: "B", bg: "#1C1917", accent: "#EA580C" },
  { slug: "chronosphere", letter: "C", bg: "#1E1B4B", accent: "#818CF8" },
  { slug: "coralogix", letter: "C", bg: "#042F2E", accent: "#2DD4BF" },
  { slug: "render", letter: "R", bg: "#0F172A", accent: "#46E3B7" },
  { slug: "fly-io", letter: "F", bg: "#2E1065", accent: "#C084FC" },
];
