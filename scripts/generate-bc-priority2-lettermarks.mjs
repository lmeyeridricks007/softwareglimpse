#!/usr/bin/env node
/**
 * Generate SoftwareGlimpse lettermark brand marks (512×512 PNG) for BC Priority-2.
 * Not official vendor trademarks — SG-styled initials with "SG" badge.
 *
 * Usage: node scripts/generate-bc-priority2-lettermarks.mjs
 */
...
const MARKS = [
  { slug: "openphone", letter: "O", bg: "#0E2438", accent: "#3BA4C8" },
  { slug: "eightx8", letter: "8", bg: "#141C2B", accent: "#E4572E" },
  { slug: "goto-connect", letter: "G", bg: "#0F2A24", accent: "#2F9E7B" },
  { slug: "grasshopper", letter: "G", bg: "#1A2814", accent: "#6B9E3A" },
  { slug: "respond-io", letter: "R", bg: "#1A1528", accent: "#4C7CF0" },
];
