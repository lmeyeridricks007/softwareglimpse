#!/usr/bin/env node
/**
 * Lettermark brand marks for AI + IT Priority-3 slugs missing public/brands/{slug}.png
 */
...
const MARKS = [
  { slug: "synthesia", letter: "S", bg: "#0B1F33", accent: "#5EA9FF" },
  { slug: "fireflies", letter: "F", bg: "#102A1F", accent: "#F59E0B" },
  { slug: "dynatrace", letter: "D", bg: "#0C2340", accent: "#1496FF" },
  { slug: "azure-devops", letter: "A", bg: "#0B1F33", accent: "#0078D4" },
];
