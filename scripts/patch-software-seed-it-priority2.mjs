#!/usr/bin/env node
/**
 * Appends soft() entries from scripts/_it-priority2-seed-snippet.ts into
 * src/data/seed/software.ts before the closing ]; of softwareSeed.
 *
 * Append-only and idempotent. Usage:
 *   node scripts/onboard-it-priority2-batch.mjs
...
const SNIPPET_PATH = path.join(ROOT, "scripts/_it-priority2-seed-snippet.ts");
