 ...
 *
 * Usage: node scripts/generate-bc-priority1-lettermarks.mjs
 */
...
/** Distinct navy/teal palette per product — no purple neon. */
const MARKS = [
  { slug: "ringcentral", letter: "R", bg: "#0B1F33", accent: "#3D8BDB" },
  { slug: "dialpad", letter: "D", bg: "#102A1F", accent: "#2BB673" },
  { slug: "zoom", letter: "Z", bg: "#0C2340", accent: "#2D8CFF" },
  { slug: "nextiva", letter: "N", bg: "#1A1520", accent: "#E85D4C" },
  { slug: "microsoft-teams", letter: "T", bg: "#132033", accent: "#5059C9" },
  { slug: "slack", letter: "S", bg: "#1C1424", accent: "#36C5F0" },
];
