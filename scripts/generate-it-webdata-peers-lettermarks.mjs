#!/usr/bin/env node
/**
 * Lettermark brand marks for IT web-data peer slugs.
 */
...
const MARKS = [
  { slug: "oxylabs", letter: "O", bg: "#0B1F33", accent: "#00C2A8" },
  { slug: "scraperapi", letter: "S", bg: "#102A43", accent: "#3B82F6" },
  { slug: "apify", letter: "A", bg: "#1A1033", accent: "#8B5CF6" },
  { slug: "thordata", letter: "T", bg: "#1C1917", accent: "#F97316" },
];
