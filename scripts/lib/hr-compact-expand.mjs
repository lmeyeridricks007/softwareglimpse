/**
 * Expand compact HR / workforce / training product configs into full onboard objects.
 */
import {
  freePlan,
  contactSalesPlan,
...
export function expandHrProduct(c) {
  ...
  return {
    ...
    useCaseSlugs: c.useCaseSlugs ?? ["recruiting-ats"],
    teamTypeSlugs: c.teamTypeSlugs ?? ["recruiting", "operations"],
