/**
 * Expand compact AI product configs into full onboard objects.
 */
import {
  freePlan,
  contactSalesPlan,
...
export function expandAiProduct(c) {
  ...
  return {
    ...
    useCaseSlugs: c.useCaseSlugs ?? ["llm-assistant"],
