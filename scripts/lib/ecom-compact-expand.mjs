/**
 * Expand compact Ecommerce / training product configs into full onboard objects.
 */
import {
  freePlan,
  contactSalesPlan,
...
export function expandEcomProduct(c) {
  ...
  return {
    ...
    useCaseSlugs: c.useCaseSlugs ?? ["online-storefront"],
    teamTypeSlugs: c.teamTypeSlugs ?? ["operations", "marketing"],
