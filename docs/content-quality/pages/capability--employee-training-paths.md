...
| Field | Value |
| --- | --- |
| Route | `/capabilities/employee-training-paths/` |
...
| Subject Depth | 4/5 | 1.2 | Found 8 depth signal(s); 5 high-value categories covered. |
...
- Subject Depth: Found 8 depth signal(s); 5 high-value categories covered.
