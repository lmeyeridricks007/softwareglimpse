...
| Field | Value |
| --- | --- |
| Route | `/resources/crm-security-checklist/` |
| Page type | resource |
| Status | STRONG |
...
| Journey / Next Step | 5/5 | 0.8 | Next step fits journey stage (security). |
...
- Journey / Next Step: Next step fits journey stage (security).
