...
| Field | Value |
| --- | --- |
| Route | `/guides/how-to-choose-social-media-management-software/` |
| Page type | guide |
| Status | STRONG |
...
This guide page is in good editorial shape overall (80/100), with remaining gaps listed below.
...
| Content Completeness | 4/5 | 1.1 | Missing: faq |
...
| Visual / Media Support | 2/5 | 0.8 | Add workflow diagram, matrix, screenshot, or teaching figure — not decorative filler. |
...
| Page-Type Specific Quality | 3/5 | 1.2 | Failed: teaching-visual, unique-hero |
...
- Add expected section “faq” for Guide.
- Add a teaching visual (workflow, matrix, screenshot, checklist) with a caption that explains the concept.
- Satisfy page-type checklist item “teaching-visual”.
- Satisfy page-type checklist item “unique-hero”.
