...
| Decision Support | 5/5 | 0.8 | Decision support present: selection framework; checklist; tool handoff; scorecard. |
...
- Decision Support: Decision support present: selection framework; checklist; tool handoff; scorecard.
