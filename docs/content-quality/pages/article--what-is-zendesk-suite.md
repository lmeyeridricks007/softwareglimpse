...
| Field | Value |
| --- | --- |
| Route | `/guides/what-is-zendesk-suite/` |
| Page type | article |
| Status | EXCELLENT |
...
| Decision Support | 5/5 | 0.5 | Decision support present: selection framework; checklist; tool handoff; best-fit scenarios; scorecard. |
...
| Visual / Media Support | 4/5 | 0.4 | Teaching visuals present (1). |
