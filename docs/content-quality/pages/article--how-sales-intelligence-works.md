...
| Field | Value |
| --- | --- |
| Route | `/guides/how-sales-intelligence-works/` |
| Page type | article |
| Status | STRONG |
...
| Journey / Next Step | 5/5 | 0.8 | Next step fits journey stage (understand). |
...
- Journey / Next Step: Next step fits journey stage (understand).
