...
| Field | Value |
| --- | --- |
| Route | `/guides/sales-intelligence-crm-sync-explained/` |
| Page type | guide |
| Status | STRONG |
...
This guide page is in good editorial shape overall (86/100), with remaining gaps listed below.
...
| Actionability | 4/5 | 1 | Actionable outs: use checklist; follow next step; follow step-by-step process. |
...
- Content Completeness: Missing 1 expected section(s) for guide.
