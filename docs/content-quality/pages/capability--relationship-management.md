...
| Field | Value |
| --- | --- |
| Route | `/capabilities/relationship-management/` |
...
| Agent | CapabilityQualityAgent |
| Profile | CapabilityQualityProfile |
...
This capability page is in good editorial shape overall (90/100), with remaining gaps listed below.
...
| Original Value | 3/5 | 1 | Original value signals: vertical / job-specific taxonomy; workflow framing. |
...
| Decision Support | 5/5 | 1 | Decision support present: capability priorities; buying framework; Finder / tool integration; Requirements Builder hando |
...
| Content Differentiation | 5/5 | 1.1 | Page has a distinct purpose from related siblings. |
| Page-Type Specific Quality | 5/5 | 1.2 | All CapabilityQualityProfile checklist items passed. |
...
- Page-Type Specific Quality: All CapabilityQualityProfile checklist items passed.
