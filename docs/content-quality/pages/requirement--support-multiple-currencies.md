...
| Field | Value |
| --- | --- |
| Route | `/requirements/support-multiple-currencies/` |
...
This requirement page is in good editorial shape overall (89/100), with remaining gaps listed below.
...
| Subject Depth | 4/5 | 1.1 | Found 4 depth signal(s); 4 high-value categories covered. |
