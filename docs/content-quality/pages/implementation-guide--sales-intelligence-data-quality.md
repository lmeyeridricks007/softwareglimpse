...
| Field | Value |
| --- | --- |
| Route | `/guides/sales-intelligence-data-quality/` |
...
This implementation-guide page is in good editorial shape overall (88/100), with remaining gaps listed below.
...
| Actionability | 4/5 | 1.4 | Actionable outs: use checklist; follow next step; follow step-by-step process. |
| Structure / Readability | 5/5 | 0.8 | Clear opening, headings, and scannable structure. |
| Visual / Media Support | 5/5 | 0.8 | Teaching visuals present (4). |
...
- Visual / Media Support: Teaching visuals present (4).
