...
**Finished:** 2026-08-18T18:07:52.668Z  
...
| Check | Status | Reason |
| --- | --- | --- |
| `sitemap-entries` | completed | 6047 URLs |
| `canonical-policy` | completed | — |
| `url-consistency` | completed | — |
| `robots-meta-live-html` | completed | 19 pages from http://127.0.0.1:3000 |
| `status-codes-live` | completed | 19 HTTP probes |
