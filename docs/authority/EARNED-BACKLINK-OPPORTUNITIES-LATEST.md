...
### 1. Rework — RESOURCE_PAGE

- **Opportunity URL (where the list/article is):** https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems
- **Submit / request page:** https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems
...
- Contact notes: https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems — use “Know a great CRM resource? Let us know” CTA
- Submission notes: Open https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems → Contributing / “Know a great CRM resource?”
- Competitor gap class: COMPLEMENTARY

**How to submit / request**

Open https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems → Contributing / “Know a great CRM resource?”. Contact/route: https://resources.rework.com/libraries/awesome-business-resources/awesome-crm-systems — use “Know a great CRM resource? Let us know” CTA. Ask them to cite/link CRM Finder (https://www.softwareglimpse.com/tools/crm-finder/).
...
- **Link this SG page:** [CRM Requirements Template](https://www.softwareglimpse.com/resources/crm-requirements-template/) (`/resources/crm-requirements-template/`)
...
- **Link this SG page:** [CRM Vendor Scorecard](https://www.softwareglimpse.com/tools/crm-vendor-scorecard/) (`/tools/crm-vendor-scorecard/`)
- Domain: `gain.io`
- Score: **STRONG** (73)
- SEO / Referral: good / strong
- Difficulty / Effort / Likelihood: moderate / small / high
...
Open https://gain.io/blog/crm-buying-checklist-evaluation. Locate editorial/about/contact. Request a citation to CRM Vendor Scorecard (https://www.softwareglimpse.com/tools/crm-vendor-scorecard/) only where it genuinely helps their readers.

**Suggested ask** (human edit before send — do not auto-send)

> Hi — regarding “CRM Buying Checklist / Evaluation”: Article already mentions weighted scorecards; SoftwareGlimpse’s vendor scorecard tool and evaluation checklist are the interactive/downloadable counterparts to that advice. If useful for your audience, here’s our free CRM Vendor Scorecard: https://www.softwareglimpse.com/tools/crm-vendor-scorecard/. Glad to rephrase the mention to your house style.
...
- **Link this SG page:** [CRM Implementation Planner](https://www.softwareglimpse.com/tools/crm-implementation-planner/) (`/tools/crm-implementation-planner/`)
- Domain: `umbrex.com`
- Score: **STRONG** (73)
- SEO / Referral: strong / good
- Difficulty / Effort / Likelihood: moderate / small / medium
- Contact notes: —
- Submission notes: —
- Competitor gap class: COMPLEMENTARY
...
| --- | --- | --- | --- |
| Flevy | `flevy.com` | Paid link scheme | Paid marketplace / paid content distribution — not earned editorial. |
| matthew.iws.edu (template farm) | `matthew.iws.edu` | Spammy | Low-quality SEO template farm — do not pursue. |
| SpotSaaS | `spotsaas.com` | Direct competitor selling same artifact | Own CRM scorecard — not a complementary citation target. |
| Oracle NetSuite | `netsuite.com` | Vendor-locked competitor asset | NetSuite-owned requirements content — not earned third-party editorial. |
| Salesforce | `salesforce.com` | Vendor-locked competitor asset | Salesforce product template — vendor-locked. |
| Airtable | `airtable.com` | Vendor-locked competitor asset | Airtable product template — not editorial resource curation. |
| Insightly | `insightly.com` | Vendor-locked competitor asset | Insightly-promoting templates blog — vendor-locked. |
| Software Glimpse (own Medium) | `medium.com` | Own property / not third-party | Owned Medium account @software_glimpse. |
| SoftwareGlimpse | `softwareglimpse.com` | Own property / not third-party | Primary own domain. |
| Glimpse (unrelated) | `tryglimpse.com` | Irrelevant | Different company (Glimpse) — not CRM editorial fit. |
| Technology Evaluation Centers (TEC) | `technologyevaluation.com` | Paid link scheme | TEC paid/gated lead-gen — not earned free citation path. |
| SugarCRM (LinkedIn Pulse) | `linkedin.com` | Vendor-locked competitor asset | SugarCRM Pulse article — vendor-locked. |
| NOREX / GrowthZone | `norex.growthzoneapp.com` | No editorial value | Members-only download dump — no editorial page to cite from. |
| SUSE | `documentation.suse.com` | Irrelevant | Linux HA CRM shell documentation — wrong CRM meaning. |
| U.S. Small Business Administration | `sba.gov` | Irrelevant | SBA internal CRM PIA/report — not educational buyer guidance. |
